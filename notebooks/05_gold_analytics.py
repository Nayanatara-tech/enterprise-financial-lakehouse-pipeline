...
# MAGIC %sql
# MAGIC CREATE OR REPLACE TABLE finance.gold_revenue_by_region
# MAGIC AS
# MAGIC SELECT
# MAGIC Region,
...
# MAGIC
# MAGIC select * from finance.gold_revenue_by_region;
...
# MAGIC %sql
# MAGIC CREATE OR REPLACE TABLE finance.gold_top_customers_by_region
# MAGIC AS
# MAGIC SELECT
# MAGIC Region,
# MAGIC CustomerName,
...
# MAGIC ORDER BY revenue desc;
# MAGIC
# MAGIC select * from finance.gold_top_customers_by_region;
...
# MAGIC %sql
# MAGIC CREATE OR REPLACE TABLE finance.gold_monthly_trend AS
# MAGIC SELECT
...
# MAGIC
# MAGIC select * from finance.gold_monthly_trend
...
# MAGIC %sql
# MAGIC CREATE OR REPLACE TABLE finance.gold_currency_distribution as
...
# MAGIC
# MAGIC select * from finance.gold_currency_distribution
# MAGIC